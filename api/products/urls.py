...
from . import views
from .productsApi import create_product, delete_product, update_product, get_products, get_single_product, submit_review

urlpatterns = [
    path('', views.render_products, name= 'render_products'),
    path('<str:product_id>', get_single_product, name='get_single_product'),
